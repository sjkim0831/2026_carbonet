import { SummaryCard } from "./homeEntryTypes";
...
export const LOCALIZED_CONTENT = {
  ko: {
    ...
    popularTags: ["#배출량산정", "#인증서발급", "#크레딧거래", "#수수료안내"],
    coreServicesTitle: "주요 서비스",
    coreServicesDescription: "CCUS 탄소발자국 플랫폼의 핵심 기능을 바로 이용해보세요.",
    services: [
      ["factory", "탄소배출 산정", "산업 공정별 이산화탄소 배출량을 시뮬레이션하고 산정합니다."],
      ["verified_user", "보고서 & 인증서", "검증된 배출량에 대한 공식 인증서를 신청하고 발급받습니다."],
      ["database", "탄소 정보 조회", "유통되는 탄소의 출처와 관련된 상세 데이터를 확인합니다."],
      ["storefront", "탄소 거래소", "탄소 크레딧 및 배출권을 투명하게 거래할 수 있습니다."],
      ["monitoring", "실시간 모니터링", "국가 및 개별 사업장의 탄소 현황을 대시보드로 제공합니다."],
      ["credit_card", "통합 결제", "이용 수수료 및 거래 대금을 안전하게 결제합니다."],
      ["support_agent", "고객 지원 센터", "이용 중 발생하는 문의사항을 신속하게 해결해 드립니다."],
      ["menu_book", "플랫폼 이용 가이드", "처음 방문자를 위한 단계별 이용 방법을 안내합니다."]
    ],
    ...
    footerLinks: ["개인정보처리방침", "이용약관", "이메일무단수집거부", "찾아오시는 길"],
    lastModified: "최종 수정일:",
    waAlt: "웹 접근성 품질인증 마크"
  },
  en: {
    ...
    popularTags: ["#EmissionCalculation", "#CertificationIssuance", "#CreditTrading", "#FeeGuide"],
    coreServicesTitle: "Core Services",
    coreServicesDescription: "Access the key features of the CCUS Carbon Footprint Platform.",
    services: [
      ["factory", "Emission Calculation", "Simulate and calculate CO2 emissions for various industrial processes."],
      ["verified_user", "Reports & Certificates", "Apply for and receive official certificates for verified emission levels."],
      ["database", "Carbon Data Inquiry", "Check detailed data related to the origin and distribution of carbon."],
      ["storefront", "Carbon Marketplace", "Transparently trade carbon credits and emission allowances."],
      ["monitoring", "Real-time Monitoring", "Dashboards displaying national and enterprise-level carbon status."],
      ["credit_card", "Integrated Payment", "Securely pay service fees and transaction amounts."],
      ["support_agent", "Customer Support", "Quickly resolve inquiries or issues encountered during platform use."],
      ["menu_book", "Platform Guide", "Step-by-step guidance for first-time visitors to the platform."]
    ],
    summaryTitle: "Real-time Data Summary",
    summaryDescription: "Key indicators for national CCUS activity monitoring (cumulative for 2025)",
    ...
    summaryCards: [
      {
        ...
        value: "1,452,890",
        unit: "tCO2",
        progressLabel: "Annual Target (2,000,000 tCO2)",
        progressValue: "72.6%",
        progressWidth: "72.6%"
      },
      {
        ...
        statBlocks: [
          { label: "Commercialization", value: "18", unit: "Cases" },
          { label: "Pilot Programs", value: "27", unit: "Cases" }
        ],
        note: "15% increase in activity compared to the previous quarter"
      },
      {
        title: "Certification Service Status",
        ringText: "85%",
        rows: [
          { label: "Verification Complete", value: "124" },
          { label: "Under Review", value: "22" }
        ],
        ringNote: "Review backlog is being reduced"
      }
    ] as SummaryCard[],
    footerOrg: "CCUS Integrated Management Center",
    footerAddress: "(04551) 110 Sejong-daero, Jung-gu, Seoul | Main line: 02-1234-5678 (Weekdays 09:00-18:00)",
    footerDesc: "This service manages greenhouse gas reduction performance in accordance with applicable laws and regulations.",
    footerLinks: ["Privacy Policy", "Terms of Use", "Email Collection Refusal", "Directions"],
