...
const CONTENT: Record<"ko" | "en", LocalizedContent> = {
  ko: {
    governmentText: "대한민국 정부 공식 서비스 | 컴플라이언스 워크플로우 센터",
    governmentStatus: "시스템 실시간 감시 중",
    pageTitle: "통합 컴플라이언스 허브",
    pageSubtitle: "Workflow-Driven Compliance Hub",
    navItems: ["액션 대시보드", "전체 사이트 모니터링", "검증 워크플로우", "규제 준수 현황"],
    supervisorLabel: "지정 감독관",
    supervisorName: "이현장 관리자님",
    assistantCount: "5",
    systemButton: "운영 콘솔",
    skipToContent: "본문 바로가기",
    heroTitle: "Intelligent Update Assistant",
    heroStatus: "Guided Compliance Agent",
    heroBriefingTitle: "오늘의 핵심 브리핑",
    heroBriefingBody: "현재 5개의 긴급 업데이트가 감지되었습니다. 특히 울산 제3 기지의 서류 누락은 이번 주 검증 일정에 영향을 줄 수 있으므로 아래 워크플로우 순서대로 즉시 조치를 시작해야 합니다.",
    heroPrimaryMetricLabel: "진행률",
    heroPrimaryMetricValue: "65%",
    heroSecondaryMetricLabel: "완료 업무",
    heroSecondaryMetricValue: "12/17",
    queueTitle: "Your Update Queue (Prioritized)",
    queueCountSuffix: "Items Found",
    ...
    queueSummaryTitle: "즉시 조치 포인트",
    queueSummaryItems: [
      { key: "critical", label: "긴급 조치" },
      { key: "required", label: "필수 업데이트" },
      { key: "verification", label: "검증 대기" }
    ],
    workflowTitle: "검증 워크플로우",
    workflowBody: "reference 화면의 핵심 흐름을 현재 홈 포털 구조에 맞게 재구성했습니다. 우선순위 큐, 단계형 실행 흐름, 운영 가이드를 한 화면에서 이어서 처리할 수 있습니다.",
    workflowSteps: [
      {
        key: "capture",
        label: "01",
        title: "이슈 감지",
        body: "문서 누락, 데이터 변경, 배출계수 이상을 우선 수집합니다."
      },
      {
        key: "validate",
        label: "02",
        title: "증빙 검토",
        body: "기존 제출 이력과 금월 기준값을 대조해 보완 항목을 확정합니다.",
        active: true
      },
      {
        key: "respond",
        label: "03",
        title: "조치 실행",
        body: "담당자 호출, 입력기 이동, 검증 요청까지 연결합니다."
      },
      {
        key: "close",
        label: "04",
        title: "승인 및 종료",
        body: "검토 결과를 보고서와 운영 로그에 반영하고 마감합니다."
      }
    ],
    guidanceTitle: "운영 가이드 보드",
    guidanceBody: "현재 Carbonet 홈 앱에서 바로 이어지는 주요 진입점을 묶었습니다.",
    guidanceCards: [
      {
        key: "realtime",
        icon: "monitoring",
        eyebrow: "MONITORING",
        title: "실시간 모니터링 연결",
        body: "현장 상태와 이탈 징후를 바로 확인하고 사업장 단위 상세 화면으로 이어집니다.",
        metricLabel: "집중 감시 사업장",
        metricValue: "18 Sites",
        action: "실시간 현황 보기",
      ...
      },
      {
        ...
        eyebrow: "VALIDATION",
        title: "산정 검증 흐름",
        body: "누락 서류 확인, 검증 요청, 반려 이력 점검을 한 번에 처리합니다.",
        metricLabel: "검증 대기 건",
        metricValue: "07 Cases",
        action: "검증 화면 열기",
      ...
      },
      {
        ...
        title: "무결성 추적",
        body: "연계 로그와 데이터 무결성 상태를 확인해 이슈의 원인 경로를 좁힙니다.",
        metricLabel: "정상 연계율",
        metricValue: "99.8%",
        action: "무결성 화면 열기",
        href: "/co2/integrity"
    ...
    timelineTitle: "오늘의 운영 일정",
    timelineBody: "대시보드 하단에는 즉시 이어갈 다음 액션을 타임라인으로 정리했습니다.",
    timelineItems: [
      {
        key: "08",
        label: "08:30",
        title: "울산 제3 서류 보완 요청 발송",
        body: "현장 담당자에게 Tier 3 전력 증빙 2건 재제출 요청",
        href: "/monitoring/track"
      },
      {
        key: "10",
        label: "10:00",
        title: "포항 제1 데이터 확정 검토",
        body: "8월 에너지 사용량 고지서와 입력값 대조",
        href: "/emission/simulate"
      },
      {
        key: "14",
        label: "14:00",
        title: "규제 준수 회의 브리핑 생성",
        body: "보고서 작성 화면으로 이동해 금일 검토 내역 반영",
        href: "/certificate/report_form"
      }
    ],
    footerOrg: "CCUS 통합관리본부",
    footerAddress: "(04551) 서울특별시 중구 세종대로 110",
    footerServiceLine: "환경 모니터링 운영실 02-1234-5678",
    footerLinks: ["개인정보처리방침", "운영 가이드", "데이터 거버넌스", "문의하기"],
    footerCopyright: "© 2026 CCUS Carbon Footprint Platform. Workflow-Driven Compliance Hub.",
    ...
    queueItems: [
      {
        ...
        due: "D-2 Deadline",
        icon: "priority_high",
        title: "울산 제3 화학기지: 산정 증빙 서류 보완",
        body: "배출계수 재산정 로직에 따른 Tier 3 전력 증빙 서류 2건이 누락되었습니다.",
        collaborators: ["1", "2", "3"],
        secondaryAction: "이력 비교",
        secondaryHref: "/monitoring/track",
        primaryAction: "워크플로우 시작",
      ...
      },
      {
        ...
        title: "포항 제1 열연공장: 8월 에너지 데이터 확정",
        body: "전력 사용량 고지서 대조 및 최종 확정 승인 절차가 관리자 확인 대기 상태입니다.",
        primaryAction: "데이터 입력기",
      ...
      },
      {
        ...
        due: "Board Review",
        icon: "verified",
        title: "광양 제2 에너지센터: 감축 계획서 검증",
        body: "연말 목표 초과 가능성에 대한 대응 계획서 검토와 승인 의견 정리가 필요합니다.",
      ...
      },
      {
        ...
        due: "API Sync",
        icon: "sync_problem",
        title: "인천 물류센터: 외부 연계 로그 점검",
        body: "야간 배치 이후 연계 응답 시간이 증가해 운영 콘솔에서 최근 이벤트 검토가 필요합니다.",
        secondaryAction: "운영 콘솔",
        secondaryHref: "/admin/external/monitoring",
        primaryAction: "로그 대시보드",
      ...
      },
      {
        ...
        due: "17:00 Briefing",
        icon: "description",
        title: "금일 준수 현황 브리핑 패키지 생성",
        body: "사업장별 검증 현황과 미해결 이슈를 모아 오후 회의용 요약본을 준비해야 합니다.",
  ...
  en: {
    governmentText: "Republic of Korea Official Service | Compliance Workflow Center",
    governmentStatus: "Real-time system monitoring active",
    pageTitle: "Integrated Compliance Hub",
    pageSubtitle: "Workflow-Driven Compliance Hub",
    navItems: ["Action Dashboard", "Site Monitoring", "Validation Workflow", "Compliance Status"],
    supervisorLabel: "Assigned Supervisor",
    supervisorName: "Manager Lee",
    assistantCount: "5",
    systemButton: "Ops Console",
    skipToContent: "Skip to content",
    heroTitle: "Intelligent Update Assistant",
    heroStatus: "Guided Compliance Agent",
    heroBriefingTitle: "Today's briefing",
    heroBriefingBody: "Five urgent updates were detected. Missing documents from Ulsan Site 3 could affect this week's validation schedule, so the workflow below should start immediately.",
    heroPrimaryMetricLabel: "Progress",
    heroPrimaryMetricValue: "65%",
    heroSecondaryMetricLabel: "Completed",
    heroSecondaryMetricValue: "12/17",
    queueTitle: "Your Update Queue (Prioritized)",
    queueCountSuffix: "Items Found",
    ...
    queueSummaryTitle: "Immediate action points",
    queueSummaryItems: [
      { key: "critical", label: "Critical actions" },
      { key: "required", label: "Required updates" },
      { key: "verification", label: "Verification queue" }
    ],
    workflowTitle: "Validation Workflow",
    workflowBody: "The reference dashboard flow was rebuilt for the current home portal. Priority queue, step execution, and operator guidance are connected on one page.",
    workflowSteps: [
      {
        key: "capture",
        label: "01",
        title: "Detect issues",
        body: "Capture missing documents, source changes, and emission-factor anomalies first."
      },
      {
        key: "validate",
        label: "02",
        title: "Review evidence",
        body: "Compare current submissions against monthly baselines and finalize missing items.",
        active: true
      },
      {
        key: "respond",
        ...
        body: "Call owners, open the input flow, and trigger validation requests."
      },
      {
        key: "close",
        label: "04",
        title: "Approve and close",
        body: "Reflect findings in reports and operation logs before closing."
      }
    ],
    guidanceTitle: "Operator Guidance Board",
    guidanceBody: "These are the main entry points connected directly from the current Carbonet home app.",
    guidanceCards: [
      {
        key: "realtime",
        icon: "monitoring",
        ...
        body: "Review site anomalies and move directly into the facility-level monitoring view.",
        metricLabel: "Focused sites",
        metricValue: "18 Sites",
      ...
      },
      {
        ...
        icon: "task_alt",
        eyebrow: "VALIDATION",
        title: "Emission validation flow",
        body: "Handle missing documents, validation requests, and rejected history in one place.",
        metricLabel: "Pending cases",
        metricValue: "07 Cases",
        action: "Open validation",
        href: "/en/emission/validate"
      },
      {
        key: "integrity",
        icon: "verified_user",
        eyebrow: "TRACEABILITY",
        title: "Integrity trace",
        body: "Review linked logs and integrity status to narrow down root-cause paths.",
    ...
    timelineTitle: "Today's operation schedule",
    timelineBody: "The lower section organizes the next concrete actions as a compact timeline.",
    timelineItems: [
      {
        key: "08",
        label: "08:30",
        title: "Send Ulsan Site 3 remediation request",
        body: "Request resubmission of two Tier 3 electricity evidence documents",
        href: "/en/monitoring/track"
      },
      {
        key: "10",
        label: "10:00",
        title: "Review Pohang energy finalization",
        body: "Compare August bill data with the submitted usage values",
        href: "/en/emission/simulate"
      },
      {
        key: "14",
        label: "14:00",
        title: "Generate compliance briefing",
        body: "Move to the report form and reflect today's review status",
    ...
    footerServiceLine: "Monitoring Operations Center +82-2-1234-5678",
    footerLinks: ["Privacy Policy", "Ops Guide", "Data Governance", "Contact"],
    footerCopyright: "© 2026 CCUS Carbon Footprint Platform. Workflow-Driven Compliance Hub.",
    ...
    queueItems: [
      {
        ...
        due: "D-2 Deadline",
        icon: "priority_high",
        title: "Ulsan Chemical Base 3: evidence package remediation",
        body: "Two Tier 3 electricity evidence documents are missing after emission-factor recalculation.",
        collaborators: ["1", "2", "3"],
        secondaryAction: "Compare history",
        secondaryHref: "/en/monitoring/track",
        primaryAction: "Start workflow",
      ...
      },
      {
        ...
        due: "Monthly Update",
        icon: "pending_actions",
        title: "Pohang Mill 1: finalize August energy data",
        body: "Power bill reconciliation and final approval are waiting for manager review.",
        primaryAction: "Open data entry",
      ...
      },
      {
        ...
        due: "Board Review",
        icon: "verified",
        title: "Gwangyang Center 2: validate mitigation plan",
        body: "Review and approval notes are needed for the year-end exceedance response plan.",
        secondaryAction: "Open integrity trace",
        secondaryHref: "/en/co2/integrity",
        primaryAction: "Open report form",
      ...
      },
      {
        ...
        due: "API Sync",
        icon: "sync_problem",
        title: "Incheon Logistics Center: inspect linked operation logs",
        body: "Night batch latency increased, so the recent event trail should be reviewed in the ops console.",
        secondaryAction: "Open ops console",
        secondaryHref: "/en/admin/external/monitoring",
        primaryAction: "Open log dashboard",
      ...
      },
      {
        ...
        due: "17:00 Briefing",
        icon: "description",
        title: "Generate today's compliance briefing package",
        body: "Collect site-by-site validation status and unresolved issues for the afternoon review.",
...
export function MonitoringDashboardMigrationPage() {
  const en = isEnglish();
  ...
  useEffect(() => {
    logGovernanceScope("PAGE", "monitoring-dashboard", {
      language: en ? "en" : "ko",
      queueFilter,
          ...
          <div className="mx-auto max-w-[1440px] px-4 lg:px-8">
            <div className="flex min-h-20 flex-col gap-4 py-4 xl:flex-row xl:items-center xl:justify-between">
              ...
              <div className="flex flex-wrap items-center justify-end gap-3">
                ...
                <UserLanguageToggle en={en} onKo={() => navigate("/monitoring/dashboard")} onEn={() => navigate("/en/monitoring/dashboard")} />
