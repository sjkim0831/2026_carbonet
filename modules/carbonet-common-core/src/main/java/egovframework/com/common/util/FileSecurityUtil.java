/**
 *  Class Name : FileSecurityUtil.java
...
import egovframework.com.common.service.AppProperties;
import egovframework.com.common.util.ResourceCloseHelper;
...
public class FileSecurityUtil {
  ...
  private static final String STORE_FILE_PATH = ""; // AppProperties.getProperty("Globals.fileStorePath");
  // 파일구분자
  ...
  public static boolean encryptFile(String source, String target) throws Exception {
    ...
    File srcFile = new File(WebUtil.filePathBlackList(STORE_FILE_PATH + FilenameUtils.getName(source)));
    ...
    try {
      if (srcFile.exists() && srcFile.isFile()) {
        ...
        output = new BufferedOutputStream(
            new FileOutputStream(WebUtil.filePathBlackList(STORE_FILE_PATH + FilenameUtils.getName(target))));
