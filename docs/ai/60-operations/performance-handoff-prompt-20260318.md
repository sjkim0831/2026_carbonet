...
Use this prompt when another AI session must continue the performance and algorithm upgrade work in `/opt/projects/carbonet`.
...
1. `/opt/projects/carbonet/AGENTS.md`
2. `/opt/projects/carbonet/docs/architecture/performance-algorithm-upgrade-notes.md`
3. `/opt/projects/carbonet/.codex/skills/carbonet-ai-session-orchestrator/SKILL.md`
4. `/opt/projects/carbonet/.codex/skills/carbonet-audit-trace-architecture/SKILL.md`
5. `/opt/projects/carbonet/src/main/java/egovframework/com/feature/admin/web/AdminMainController.java`
6. `/opt/projects/carbonet/src/main/java/egovframework/com/common/util/ReactPageUrlMapper.java`
7. `/opt/projects/carbonet/frontend/src/app/screen-registry/pageManifestIndex.ts`
8. `/opt/projects/carbonet/src/main/java/egovframework/com/common/util/FeatureCodeBitmap.java`
9. `/opt/projects/carbonet/src/main/java/egovframework/com/common/menu/service/impl/SiteMapServiceImpl.java`
10. `/opt/projects/carbonet/src/main/java/egovframework/com/feature/home/service/impl/HomeMenuServiceImpl.java`
11. `/opt/projects/carbonet/src/main/java/egovframework/com/feature/admin/service/impl/MenuInfoServiceImpl.java`

## Continuation prompt

```text
/opt/projects/carbonet 에서 성능/알고리즘 업그레이드를 이어서 진행해라.
