...
- `carbonet-feature-builder`
  ...
  - Use for: page management, feature management, menu metadata, bilingual admin templates, `PAGE_CODE_VIEW` authority-chain work, and the five-screen admin permission restoration set (`auth_group`, `auth_change`, `dept_role_mapping`, `member_edit`, `admin_account`).
