...
public class CarbonetAccessDeniedHandler extends EgovAccessDeniedHandler {
    ...
    public CarbonetAccessDeniedHandler(String accessDeniedUrl, String csrfAccessDeniedUrl) {
        super(accessDeniedUrl, csrfAccessDeniedUrl);
        this.accessDeniedUrl = safeString(accessDeniedUrl);
        this.csrfAccessDeniedUrl = safeString(csrfAccessDeniedUrl);
    }
