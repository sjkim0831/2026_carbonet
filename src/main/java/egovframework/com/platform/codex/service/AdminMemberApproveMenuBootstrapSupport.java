...
@Slf4j
public class AdminMemberApproveMenuBootstrapSupport {
    ...
    private static final String MENU_CODE = "A0010103";
    private static final String MENU_NAME_KO = "회원 승인";
    private static final String MENU_NAME_EN = "Member Approval";
    private static final String MENU_URL = "/admin/member/approve";
    private static final String MENU_ICON = "how_to_reg";
    ...
    private CodexProvisionRequest buildRequest() {
        ...
        request.setFeatures(Arrays.asList(
                featureRequest(MENU_CODE + "_VIEW", "회원 승인 조회", "View member approval", "Member approval page access"),
                featureRequest(MENU_CODE + "_APPROVE", "회원 승인 처리", "Process member approval", "Approve or reject member registration")
        ));
