...
@Slf4j
public class AdminMenuManagementMenuBootstrapSupport {
    ...
    private static final String GROUP_NAME = "운영 도구";
    private static final String GROUP_NAME_EN = "Operational Tools";
    private static final String MENU_CODE = "A0060107";
    private static final String MENU_NAME_KO = "메뉴 관리";
    private static final String MENU_NAME_EN = "Menu Management";
    private static final String MENU_URL = "/admin/system/menu";
    ...
    public void ensureMenuManagementMenu() {
        try {
    ...
    private CodexProvisionRequest buildRequest() {
        ...
        request.setFeatures(Arrays.asList(
                featureRequest(MENU_CODE + "_VIEW", "메뉴 관리 조회", "View menu management", "Menu management page access"),
                featureRequest(MENU_CODE + "_SAVE", "메뉴 변경 저장", "Save menu changes", "Save menu structure and visibility changes")
        ));
        request.setAuthors(Arrays.asList(
                authorRequest("ROLE_SYSTEM_MASTER", "시스템 마스터", "System Master", MENU_CODE + "_VIEW", MENU_CODE + "_SAVE"),
                authorRequest("ROLE_SYSTEM_ADMIN", "시스템 관리자", "System Administrator", MENU_CODE + "_VIEW", MENU_CODE + "_SAVE")
        ));
        return request;
    }
