...
@Slf4j
public class AdminUnifiedLogMenuBootstrap {
    ...
    private CodexProvisionRequest buildRequest() {
        ...
        request.setFeatures(Arrays.asList(
                featureRequest(MENU_CODE + "_VIEW", "통합 로그 조회", "View Unified Logs", "Unified log page access")
        ));
