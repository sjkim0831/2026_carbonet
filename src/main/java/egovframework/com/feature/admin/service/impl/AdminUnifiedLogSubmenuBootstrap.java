...
@Slf4j
public class AdminUnifiedLogSubmenuBootstrap {
    ...
    private List<SubmenuDefinition> submenuDefinitions() {
        return Arrays.asList(
                new SubmenuDefinition("A0060305", "추적 로그", "Trace Logs", "/admin/system/unified_log/trace", "timeline", "TRACE_VIEW"),
                new SubmenuDefinition("A0060306", "페이지 이벤트 로그", "Page Event Logs", "/admin/system/unified_log/page-events", "pageview", "PAGE_VIEW"),
                new SubmenuDefinition("A0060307", "UI 액션 로그", "UI Action Logs", "/admin/system/unified_log/ui-actions", "touch_app", "UI_ACTION"),
                new SubmenuDefinition("A0060308", "API 추적 로그", "API Trace Logs", "/admin/system/unified_log/api-trace", "api", "API_REQUEST"),
                new SubmenuDefinition("A0060309", "UI 오류 로그", "UI Error Logs", "/admin/system/unified_log/ui-errors", "bug_report", "UI_ERROR"),
                new SubmenuDefinition("A0060310", "레이아웃 렌더 로그", "Layout Render Logs", "/admin/system/unified_log/layout-render", "dashboard_customize", "LAYOUT_RENDER")
        );
    }
