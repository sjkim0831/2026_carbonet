...
public class EmployeeMemberServiceImpl extends EgovAbstractServiceImpl implements EmployeeMemberService {
	...
	public void deleteUser(String checkedIdForDel) {
		...
		String [] delId = StringUtil.isNullToString(checkedIdForDel).split(",");
	...
	public String insertUser(UserManageVO userManageVO) throws Exception {
		...
		//패스워드 암호화
		String pass = FileSecurityUtil.encryptPassword(userManageVO.getPassword(), StringUtil.isNullToString(userManageVO.getEmplyrId()));//KISA 보안약점 조치 (2018-10-29, 윤창원)
		userManageVO.setPassword(pass);
		String result = userManageMapper.insertUser(userManageVO);
		return result;
	}
	...
	public UserManageVO selectUser(String uniqId) {
		UserManageVO userManageVO = userManageMapper.selectUser(uniqId);
		return userManageVO;
	}
	...
	public List<UserManageVO> selectUserList(UserDefaultVO userSearchVO) {
		List<UserManageVO> result = userManageMapper.selectUserList(userSearchVO);
		return result;
	}
	...
	public int selectUserListTotCnt(UserDefaultVO userSearchVO) {
		return userManageMapper.selectUserListTotCnt(userSearchVO);
	}
	...
	public String insertUserHistory(UserManageVO userManageVO) {
		return userManageMapper.insertUserHistory(userManageVO);
	}
	...
	public UserManageVO selectPassword(UserManageVO passVO) {
		UserManageVO userManageVO = userManageMapper.selectPassword(passVO);
		return userManageVO;
	}
	...
	public void updateLockIncorrect(UserManageVO userManageVO) throws Exception {
		userManageMapper.updateLockIncorrect(userManageVO);
	}
