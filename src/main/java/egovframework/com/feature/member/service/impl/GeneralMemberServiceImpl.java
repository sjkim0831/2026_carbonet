...
import egovframework.com.feature.member.service.GeneralMemberService;
...
public class GeneralMemberServiceImpl extends EgovAbstractServiceImpl implements GeneralMemberService {
	...
	public String insertMber(MberManageVO mberManageVO) throws Exception  {
		...
		//패스워드 암호화
		String pass = FileSecurityUtil.encryptPassword(mberManageVO.getPassword(), StringUtil.isNullToString(mberManageVO.getMberId()));//KISA 보안약점 조치 (2018-10-29, 윤창원)
		mberManageVO.setPassword(pass);

		String result = mberManageMapper.insertMber(mberManageVO);
		return result;
	}
	...
	public MberManageVO selectMber(String uniqId) {
		MberManageVO mberManageVO = mberManageMapper.selectMber(uniqId);
		return mberManageVO;
	}
	...
	public MberManageVO selectPassword(MberManageVO passVO) {
		MberManageVO mberManageVO = mberManageMapper.selectPassword(passVO);
		return mberManageVO;
	}
