 ...
 * </pre>
 */
@Repository("mberManageMapper")
public class MberManageMapper extends BaseMapperSupport{
	...
	public List<MberManageVO> selectMberList(UserDefaultVO userSearchVO){
        return selectList("mberManageMapper.selectMberList", userSearchVO);
    }
    ...
    public int selectMberListTotCnt(UserDefaultVO userSearchVO) {
        return (Integer)selectOne("mberManageMapper.selectMberListTotCnt", userSearchVO);
    }
    ...
    public void deleteMber(String delId){
        delete("mberManageMapper.deleteMber_S", delId);
    }
    ...
    public String insertMber(MberManageVO mberManageVO){
        return String.valueOf((int)insert("mberManageMapper.insertMber_S", mberManageVO));
    }
    ...
    public MberManageVO selectMber(String mberId){
        return (MberManageVO) selectOne("mberManageMapper.selectMber_S", mberId);
    }
    ...
    public void updateMber(MberManageVO mberManageVO){
        update("mberManageMapper.updateMber_S",mberManageVO);
    }
    ...
    public List<StplatVO> selectStplat(String stplatId){
    	return selectList("mberManageMapper.selectStplat_S", stplatId);
    }
    ...
    public void updatePassword(MberManageVO passVO) {
        update("mberManageMapper.updatePassword_S", passVO);
    }
    ...
    public MberManageVO selectPassword(MberManageVO mberManageVO){
    	return (MberManageVO) selectOne("mberManageMapper.selectPassword_S", mberManageVO);
    }
    ...
    public void updateLockIncorrect(MberManageVO mberManageVO) {
        update("mberManageMapper.updateLockIncorrect", mberManageVO);
    }
