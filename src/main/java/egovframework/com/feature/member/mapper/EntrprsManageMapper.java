...
public class EntrprsManageMapper extends BaseMapperSupport {
    ...
    public List<EntrprsMberFileVO> selectEntrprsMberFiles(String entrprsmberId) {
        return selectList("entrprsManageMapper.selectEntrprsMberFiles", entrprsmberId);
    }

    public EntrprsMberFileVO selectEntrprsMberFileByFileId(String fileId) {
        return (EntrprsMberFileVO) selectOne("entrprsManageMapper.selectEntrprsMberFileByFileId", fileId);
    }
    ...
    public EntrprsManageVO selectEntrprsmber(String entrprsmberId) {
        return (EntrprsManageVO) selectOne("entrprsManageMapper.selectEntrprs_S", entrprsmberId);
    }
    ...
    public EntrprsManageVO selectEntrprsmberByMberId(String entrprsmberId) {
        return (EntrprsManageVO) selectOne("entrprsManageMapper.selectEntrprsByMberId_S", entrprsmberId);
    }

    public List<CompanyListItemVO> searchCompanyList(String searchKeyword) {
        return selectList("entrprsManageMapper.searchCompanyList", searchKeyword);
    }
    ...
    public int checkIdDplct(String checkId) {
        Object result = selectOne("entrprsManageMapper.checkIdDplct_S", checkId);
        return result == null ? 0 : ((Number) result).intValue();
    }
    ...
    public int checkEmailDplct(String checkEmail) {
        Object result = selectOne("entrprsManageMapper.checkEmailDplct_S", checkEmail);
        return result == null ? 0 : ((Number) result).intValue();
    }
    ...
    public List<InsttFileVO> selectInsttFiles(String insttId) {
        return selectList("entrprsManageMapper.selectInsttFiles", insttId);
    }

    public InsttFileVO selectInsttFileByFileId(String fileId) {
        return (InsttFileVO) selectOne("entrprsManageMapper.selectInsttFileByFileId", fileId);
    }
    ...
    public int checkCompanyNameDplct(String checkNm) {
        return (Integer) selectOne("entrprsManageMapper.checkCompanyNameDplct", checkNm);
    }
    ...
    public String selectLatestInsttStatusByBizrno(String bizrno) {
        Object result = selectOne("entrprsManageMapper.selectLatestInsttStatusByBizrno", bizrno);
