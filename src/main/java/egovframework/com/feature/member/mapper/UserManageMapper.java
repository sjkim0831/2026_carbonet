...
public class UserManageMapper extends BaseMapperSupport{
    ...
    public int checkIdDplct(String checkId){
        return (Integer)selectOne("userManageMapper.checkIdDplct_S", checkId);
    }
    ...
    public void deleteUser(String delId){
        delete("userManageMapper.deleteUser_S", delId);
    }
    ...
    public String insertUser(UserManageVO userManageVO){
        return String.valueOf((int)insert("userManageMapper.insertUser_S", userManageVO));
    }
    ...
    public UserManageVO selectUser(String uniqId){
        return (UserManageVO) selectOne("userManageMapper.selectUser_S", uniqId);
    }
     ...
     */
    public List<UserManageVO> selectUserList(UserDefaultVO userSearchVO){
        return selectList("userManageMapper.selectUserList_S", userSearchVO);
    }
    ...
    public int selectUserListTotCnt(UserDefaultVO userSearchVO) {
        return (Integer)selectOne("userManageMapper.selectUserListTotCnt_S", userSearchVO);
    }
    ...
    public void updateUser(UserManageVO userManageVO){
        update("userManageMapper.updateUser_S",userManageVO);
    }
    ...
    public void updatePassword(UserManageVO passVO) {
        update("userManageMapper.updatePassword_S", passVO);
    }
    ...
    public UserManageVO selectPassword(UserManageVO userManageVO){
    	return (UserManageVO) selectOne("userManageMapper.selectPassword_S", userManageVO);
    }
    ...
    public void updateLockIncorrect(UserManageVO userManageVO) {
        update("userManageMapper.updateLockIncorrect", userManageVO);
    }
